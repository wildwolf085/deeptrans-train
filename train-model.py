...
onmt_config = {
    ...
    'save_data': onmt_dir,
    'src_vocab': f"{tokenizer_dir}/{from_code}-32k.vocab",
    'tgt_vocab': f"{tokenizer_dir}/{to_code}-32k.vocab",
    ...
    'src_subword_model': f"{tokenizer_dir}/{from_code}-32k.model", 
    'tgt_subword_model': f"{tokenizer_dir}/{from_code}-32k.model", 
    'src_subword_nbest': 1, 
