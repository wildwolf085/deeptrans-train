...
onmt_config = {
    ...
    'save_data': onmt_dir,
    'src_vocab': f"{tokenizer_dir}/{from_code}_32k.vocab",
    'tgt_vocab': f"{tokenizer_dir}/{to_code}_32k.vocab",
    ...
    'src_subword_model': f"{tokenizer_dir}/{from_code}_32k.model", 
    'tgt_subword_model': f"{tokenizer_dir}/{from_code}_32k.model", 
    'src_subword_nbest': 1, 
    ...
    'share_decoder_embeddings': False, # org True
    'share_embeddings': False, # org True
    'valid_metrics': ['BLEU'],
}
